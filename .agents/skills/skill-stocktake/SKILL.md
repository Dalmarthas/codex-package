...
| Path | Description |
|------|-------------|
| `~/.agents/skills/` | Global skills (all projects) |
| `{cwd}/.agents/skills/` | Project-level skills (if the directory exists) |
...
If the project has no `.agents/skills/` directory, only global skills and commands are evaluated.
...
**Results cache:** `~/.agents/skills/skill-stocktake/results.json`

## Quick Scan Flow

Re-evaluate only skills that have changed since the last run (5–10 min).

1. Read `~/.agents/skills/skill-stocktake/results.json`
2. Run: `bash ~/.agents/skills/skill-stocktake/scripts/quick-diff.sh \
         ~/.agents/skills/skill-stocktake/results.json`
...
7. Run: `bash ~/.agents/skills/skill-stocktake/scripts/save-results.sh \
         ~/.agents/skills/skill-stocktake/results.json <<< "$EVAL_RESULTS"`
